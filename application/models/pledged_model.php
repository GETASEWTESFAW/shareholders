...
class Pledged_Model extends MY_Model {
	...
	$result = mysqli_query($conn,"INSERT INTO pludge (account_no,total_paidup_capital,name,pledged_by,plamount,pledged_status,pldate,pledged_reason,year) VALUES (
		"$data['account_no']","$data['pledgedamount']","$data['name']","$data['pledged_by']","$data['plamount']","$data['status']","$data['pldate']","$data['reason']","$data['year']")") or die(mysqli_error($conn));
