...
//-->
                  ...
                  <?php endif ?>
                                       ...
                                       $result = mysqli_query($conn,"SELECT * FROM shareholders where id ='$id'");
                                        ...
                                        $query2 = mysqli_query($conn,"SELECT *,sum(total_share_transfered_in_birr) from transfer where name = '$name'") or die(mysqli_error($conn));
                                        ...
                                        $query3 = mysqli_query($conn,"SELECT *,sum(total_share_transfered_in_birr) from transfer where rname = '$name'") or die(mysqli_error($conn));
                                        ...
                                        ?>
									 	...
									 	<div class="form-group">
                                            ...
                                            <input type="text" name="adjusted_balance" readonly="" id="Adjusted" value="<?php echo $transfer3['total_share_subscribed_inbirr']; } } } ?>" class="form-control" placeholder="Enter ..."/>
										...
										<div class="form-group">
                                         ...
                                         <div class="input-group">
	                                            ...
	                                            <input type="text" class="form-control pull-right" readonly="" value="<?php echo $cash['value_date']; } ?>" name="cash_payment_value_date">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="input-group">
	                                            ...
	                                            <input type="text" class="form-control pull-right" readonly="" value="<?php echo $capitalized['value_date']; } ?>" name="dividend_capitalized_valuedate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly name="total_raised" value="<?php echo $raised['sum(capitalized_in_birr)']; } ?>" id="ajaxDiv" class="form-control" placeholder="Enter ..."/>
                                        ...
                                        ?>
										 ...
										 <div class="form-group">
                                            <label>Total Paidup Capital</label>
                                            <input type="text" readonly name="total_paidup" id="totalpaidup" value="<?php echo $transfer1['sum(total_share_transfered_in_birr)'] - $transfer2['sum(total_share_transfered_in_birr)'] + $raised['sum(capitalized_in_birr)']; } } } ?>" class="form-control" placeholder="Enter ..."/>
                                 			<?php echo form_error('total_raised'); ?>
                                        </div>
                                    ...
                                    <?php 
                                    	if(isset($_POST['submit'])){
											...
											$query = mysqli_query($conn,"INSERT INTO dividend (name,sc_no,account_no,total_paidup_capital,adjusted_balance,dividend_payable_capitalized,dividend_payable_capitalized_date,cash_payment,cash_payment_valuedate,dividend_capitalized,dividend_capitalized_valuedate,total_raised,total_paidup) 
                                            ...
                                            header('location:http://172.23.2.174/shareholder/shareholder/listed?dividend=calculated');
