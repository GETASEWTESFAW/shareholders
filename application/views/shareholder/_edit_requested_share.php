...
<?php
  ...
  <?php } ?>
                ...
                if(isset($_GET['id'])){
                  ...
                  $query = mysqli_query($conn,"SELECT * from new_request WHERE account_no = '$acct'"); 
                                   ...
                                   <div class="form-group">
                                      ...
                                      <input type="text" readonly="" name="application_date" class="form-control" value="<?php echo $row['application_date']; ?>" placeholder="Enter ..."/>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="text" name="total_share" autofocus="" value="<?php echo $row['total_share']; ?>" class="form-control" plactaeholder="Enter ..."/>
                                 				<?php echo form_error('total_share'); ?>
                                        </div>
                                        <input type="hidden" name="account_no" autofocus="" value="<?php echo $acct; ?>" class="form-control" plactaeholder="Enter ..."/>
