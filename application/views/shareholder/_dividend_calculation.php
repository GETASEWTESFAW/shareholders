                  ...
                  <?php endif ?>
                                    ...
                                    <?php 
                                    	if(isset($_POST['submit'])){
											...
											$capitalized_share = $_POST['capitalized_share'];

											$capitalized_in_birr = $_POST['capitalized_in_birr'];
											
											$value_date = $_POST['value_date'];

											mysqli_query($conn,"INSERT into capitalized (name,capitalized_in_share,capitalized_in_birr,value_date,type) values ('$name','$capitalized_share','$capitalized_in_birr','$value_date','cash')") or die(mysqli_error($conn));
