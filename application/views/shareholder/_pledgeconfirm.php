                  ...
                  <?php endif ?>
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM shareholders where id ='$id'");
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="text" required name="pledged_amount" onKeyUp="format(this);" value="<?php echo $row['pledged_amount']; ?>" class="form-control" placeholder="Enter ..."/>
                      ...
                      $result = mysqli_query($conn,"INSERT INTO pludge (account_no,total_paidup_capital,name,pledged_by,plamount,pledged_status,pldate,pledged_reason,year) VALUES ('$account_no','$pledgedamount','$name','$pledged_by','$plamount','$status','$pldate','$reason','$year')") or die(mysqli_error($conn));
