	...
	<?php } ?>
                  ...
                  <?php endif ?>
                                    ...
                                    <?php 
										...
										$result = mysqli_query($conn,"SELECT * FROM shareholders WHERE status != 'closed' order by account_no");
...
/*
 ...
 /************************************************************/
        ...
        */
        ...
        $buyyer_transfer = mysqli_query($conn,"SELECT * FROM transfer where status_of_transfer = 'authorized' and account_no='$acct' and raccount_no = '$buyyer_acct_no' and status_of_seller = 'closed'");
        ...
        $updated_transfer_result = mysqli_query($conn,"UPDATE transfer SET total_share_transfered = '$buyyer_total_transfer_diff',total_share_transfered_in_birr = '$buyyer_total_transfer_diff_in_birr' where raccount_no = '$buyyer_acct_no' and account_no = '$acct' and status_of_transfer = 'authorized' ");
        /*
   ...
   /*
    ...
    foreach ($_POST['id'] as $ids) {
        ...
        $result = mysqli_query($conn,"UPDATE capitalized SET capitalized_status = 'authorized' where id='$ids'");
           ...
           header('location:http://127.0.0.1/shareholder_dividend/shareholder/authorize_cashpayment?authorize=ok');
