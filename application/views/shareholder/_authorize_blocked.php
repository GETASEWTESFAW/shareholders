                                ...
                                <form action="" method="POST" role="form" name="myForm" id="myForm" onSubmit="return validateForm()">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        	...
                                        	$query = mysqli_query($conn,"SELECT * from blocked where status = 'pending' order by id ASC") or die(mysqli_error($conn));
...
<input type="hidden" readonly="" value="<?php echo $rows['blocked_in_birr'];?>" name="blocked_in_birr" class="form-control"/>
                             ...
                             if (isset($_POST['reject'])){
                                         ...
                                         $account_no = $_POST['selector'];
                                            ...
                                            {   
                                              ...
                                              $result = mysqli_query($conn,"UPDATE blocked 
                                                                        SET 
                                                                            status = 'rejected',
                            ...
                            $name = $_POST['name'];
                            $blocked_amount = $_POST['blocked_in_birr'];
                            ...
                            $account_no = $_POST['selector'];                                            
                                    ...
                                    {   
                                            ...
                                            $result2 = mysqli_query($conn,"UPDATE shareholders 
                                                                        SET 
