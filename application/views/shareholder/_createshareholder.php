...
<form action="<?php echo base_url('');?>shareholder/new_shareholder" method="POST" role="form" name="myForm" id="myForm" onSubmit="return validateForm()">
  ...
  <?php echo form_error('name'); ?>
      ...
      <div class="form-group">
        ...
        <input type="text"  onKeyPress="return event.charCode > 47 && event.charCode < 58;" name="total_share_subscribed" class="form-control" value="<?php echo set_value('total_share_subscribed'); ?>" placeholder="Enter ..."/>
...
<div class="col-sm-6"> 
    ...
    <?php echo form_error('remark'); ?>
      ...
      <input type="hidden" readonly="" value="<?php echo date('Y-m-d');?>" name="data_created_at" class="form-control"/> 
      <input type="hidden" readonly="" value="<?php echo $username;?>" name="data_created_by" class="form-control"/> 
      
      <input type="hidden" readonly="" value="pending" name="status_of_new_share" class="form-control"/> 
      <input type="hidden" readonly="" value="total_share_subscribed_inbirr" name="total_share_subscribed_inbirr" class="form-control"/>
