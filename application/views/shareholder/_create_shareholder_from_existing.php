...
<form action="<?php echo base_url('');?>shareholder/new_shareholder_from_existing" method="POST" role="form" name="myForm" id="myForm" onSubmit="return validateForm()">
...
<div class="form-group">
    ...
    <?php echo form_error('remark'); ?>
      ...
      <input type="hidden" readonly="" value="zero_value" name="type_of_creation" class="form-control"/>  
