...
<?php endif ?>
			...
			<div class="form-group">
				...
				$query = mysqli_query($conn,"SELECT * FROM shareholders WHERE account_no = '$ids'") or die(mysqli_error($conn));
			...
			<input type="hidden" readonly="" value="<?php echo $_GET['ids'];?>" name="id" class="form-control"/>
