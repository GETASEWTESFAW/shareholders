...
/////////////////
	...
	$qryreport = mysqli_query($conn,"SELECT *,transfer.name FROM transfer,Shareholders WHERE transfer.status_of_transfer = 'authorized' AND transfer.raccount_no = Shareholders.account_no and transfer.account_no = 'NIB' order by transfer_date ASC") or die(mysqli_error($conn));
