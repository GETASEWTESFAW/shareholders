 ...
 <div id="homepage_search">
                          ...
                          <?php 
                                    ...
                                    if(isset($_POST['search'])){
                                          ...
                                          $query="";
                                    if($key){
                                        $query = mysqli_query($conn,"SELECT * from capitalized where capitalized_status = 'authorized' AND type = 'cash' AND name LIKE '$key%' || account_no LIKE '$key%' AND (year BETWEEN '$from' and '$to') order by id DESC") or die(mysqli_error($conn));

                                    }else{                                         
                                          $query = mysqli_query($conn,"SELECT * from capitalized where capitalized_status = 'authorized' AND type = 'cash'  AND (year BETWEEN '$from' and '$to') order by id DESC") or die(mysqli_error($conn));
                                    }
