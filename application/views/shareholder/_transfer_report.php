...
$to = $budget_result['budget_to'];
                                        	...
                                        	$query = mysqli_query($conn,"SELECT * from transfer WHERE status_of_transfer = 'authorized' AND total_share != 'NIB' order by transfer_date DESC") or die(mysqli_error($conn));
