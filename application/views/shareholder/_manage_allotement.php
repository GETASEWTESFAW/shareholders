...
$result = mysqli_query($conn,"SELECT * FROM 
                        ...
                        WHERE 
shareholders.status != 'closed' AND
shareholders.account_no = allotment.account_no AND  
(shareholders.year BETWEEN '$from' and '$to') order by shareholders.account_no");
...
} elseif(($current_due_date < $startd) || ($current_due_date > $endd)){
...
mysqli_query($conn,"UPDATE allotment set allotment = '$alloted_share',allotment_update = '$alloted_share',allot_year = '$alloted_date',due_date = '$due_date',allot_status = 'pending' WHERE account_no = '$account_no'") or die(mysqli_error($conn));
