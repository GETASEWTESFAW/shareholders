...
if(isset($_POST['submit'])){
  ...
  $total_share_transfered_in_birr = $total_share_transfered * 500;
...
if($_POST['agreement'] == 'buyer'){
  ...
  $year = date('Y');
  $transfer = mysqli_query($conn,"INSERT INTO transfer (account_no,total_share, name,raccount_no,rname,rtotal_share,total_share_transfered,total_share_transfered_in_birr,buyyer_paidup_in_birr,seller_paidup_in_birr,transfer_date,value_date,pervalue,status_of_transfer,year,agreement,agred_to,both_seller,both_buyer) 
